...
namespace Calculator
{
	...
	public class CalcEngine
	{
		...
		{
			if (calcOperation == Operator.eUpscale)
            {
				firstNumber = System.Convert.ToDouble(stringAnswer);
				calcOperation = calcOper;
				stringAnswer = $"{firstNumber}";
				decimalAdded = false;
				
				return;
			}

			if (calcOperation == Operator.eSquare)
			{
				firstNumber = System.Convert.ToDouble(stringAnswer);
				calcOperation = calcOper;
				stringAnswer = $"{firstNumber}";
		...
		public static string CalcEqual ()
		{
			...
			if ((stringAnswer != "")&&(calcOperation!=Operator.eUpscale))
			{
				...
				switch (calcOperation)
				{
					...
					case Operator.eDivide:
						...
						validEquation = true;
						break;
					case Operator.eUpscaleM: //поплава!!
